...
export default function JoinForm() {
  const { mutate: addUser, isPending: isSubmitting } = useAddUserMutation()
  ...
  return (
    <div
      className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-x-hidden">
