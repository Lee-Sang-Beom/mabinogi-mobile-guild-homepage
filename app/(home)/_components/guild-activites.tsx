...
const activities = [
  ...
  {
    title: '도전! 레이드',
    description: '레이드 신규 컨텐츠에 대한 근거없이 폭주하는 자신감, 그리고 도전과 열망이 가득합니다.',
    images: [
      '/images/(home)/img-prepare-raid.jpeg',
    ],
  },
  {
    title: '신규 길드원 지원',
...
export default function GuildActivities() {
  ...
  return (
    <section id="activities" className="py-24 relative overflow-hidden" ref={containerRef}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            마비노기 모바일에서 우리 길드가 진행하는 다양한 활동들을 소개합니다. 함께 도전하고 성장하는 즐거움을
            경험해보세요.
          </p>
        </motion.div>
          ...
          {activities.map((activity, index) => (
            ...
            >
              ...
              <div className="lg:w-1/2">
                ...
                >
                  <Link href="/community" className={'p-3'}>자세히 보기</Link>
                </Button>
              </div>
            </motion.div>
          ))}
